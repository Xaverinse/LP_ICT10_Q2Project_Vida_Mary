...
clubs = {
    ...
    "pomefiore": "<h3>Pomefiore Dorm</h3><p>A dorm based on the Fairest Queen's spirit of tenacity.</p><p>Housewarden: Rook Hunt</p><p> Twisted from Snow White</p>",
    "ignihyde": "<h3>Ignihyde Dorm</h3><p>A dorm based on the King of the Underworld's spirit of diligence.</p> <p>Housewarden: Jade Leech</p><p> Twisted from Hades in Hercules</p>",
    "diasomnia": "<h3>Diasomnia Dorm</h3><p>A dorm based on the Thorn Fairy's spirit of nobility.</p> <p>Housewarden: Silver</p><p> Twisted from Sleeping Beauty</p>",
